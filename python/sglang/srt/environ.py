...
class Envs:
    ...
    SGLANG_TP_ALL_REDUCE_BACKEND = EnvStr(None)
    SGLANG_MOVIN_NIXL_ENABLE_ALLGATHER = EnvBool(False)
    SGLANG_MOVIN_NIXL_MAX_ELEMS = EnvInt(65536)
    SGLANG_MOVIN_NIXL_ALLGATHER_MAX_ELEMS = EnvInt(262144)
    SGLANG_MOVIN_FORCE_NIXL_ALLREDUCE_AFTER_RESTORE = EnvBool(False)
    SGLANG_MOVIN_RESTORE_PROBE = EnvBool(False)
