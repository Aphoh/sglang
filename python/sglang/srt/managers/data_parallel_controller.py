...
class DataParallelController:
    ...
    def round_robin_scheduler(self, req: Req):
        ...
        if self.server_args.disaggregation_mode == "prefill":
            # Prefill node: route based on bootstrap_room to ensure consistent routing
            # with the decode side's KV receiver expectations
            assert (
            ...
            # Decode node or non-disaggregated mode: use round robin
