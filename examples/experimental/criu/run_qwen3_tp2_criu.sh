...
"${python_bin}" -c 'import flashinfer, importlib.metadata as m, movin, sglang; assert m.version("flashinfer-python") == "0.6.13"; assert flashinfer.__git_version__ == "86e3f6f49883c0995037a267b802951e889443f1"; assert m.version("flashinfer-cubin") == "0.6.13"; print("movin package:", movin.__file__); print("sglang package:", sglang.__file__)'
